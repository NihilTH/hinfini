...
export default function GuideDetail() {
  ...
  return (
    <article data-testid="guide-detail" className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="mt-10 aspect-[16/9] overflow-hidden bg-[#24221E] border border-[#3d3835]"><SmartImage eager src={guide.image} alt={guide.title} className="w-full h-full object-cover opacity-90" /></div>
